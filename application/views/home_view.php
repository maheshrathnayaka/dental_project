                                                ...
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="first name here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="postal number here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="mobile number here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="surname here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="address line 01 here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="home number here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="radio" name="optionsRadios1" id="id_radio_male" value="M" /> <label class="radio" for="id_radio_male"> Male</label>
                                                            <input type="radio" name="optionsRadios1" id="id_radio_female" value="F" /> <label class="radio" for="id_radio_female"> Female</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="address line 02 here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="work number here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="occupation here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="city here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <input type="text" class="input-block-level" placeholder="email address here..."  name="">
                                                        </div>
                                                    </div>
                                                </div>                                    
                                            </div>
                                            <div class="row-fluid">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <textarea class="input-block-level" id="ccomment" name="comment" placeholder="main reason here..."></textarea>
                                                ...
                                                <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <textarea class="input-block-level" id="ccomment" name="comment" placeholder="known allergies here..."></textarea>
                                                              <!-- <input type="text" class="input-block-level" placeholder="Text input"  name=""> -->
                                                        </div>
                                                    </div>
                                                </div>
