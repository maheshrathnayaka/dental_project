...
<!--                                            <div class="mega-title"><img src="--><?php //echo base_url(); ?><!--assets/img/gallery/icons/grid.png" alt="" style="float: left; padding-right: 15px;"/>Good for Nothing</div>-->
...
<!--                                            <div class="mega-link mega-red"></div>-->
                                    ...
                                    <!-- A GALLERY ENTRY -->
                                    <div class="mega-entry cat-one cat-all"  id="mega-entry-2"  data-src="<?php echo base_url(); ?>assets/img/gallery/image2.jpg" data-width="780" data-height="385" data-lowsize="">
                                        ...
                                        <div class="mega-coverbuttons">
                                            ...
                                            <a class="fancybox" rel="group" href="<?php echo base_url(); ?>assets/img/gallery/image2.jpg" title="Too Much !"><div class="mega-view mega-orange"></div></a>
                                        </div>
                                    ...
                                    <!-- A GALLERY ENTRY -->
                                    <div class="mega-entry cat-three cat-all"  id="mega-entry-3" data-src="<?php echo base_url(); ?>assets/img/gallery/image3.jpg" data-width="780" data-height="485">
                                        ...
                                        <div class="mega-coverbuttons">
                                            ...
                                            <a class="fancybox" rel="group" href="<?php echo base_url(); ?>assets/img/gallery/image3.jpg" title="Might is right"><div class="mega-view mega-turquoise"></div></a>
                                        </div>

                                    </div>

                                    <!-- A GALLERY ENTRY -->
                                    <div class="mega-entry cat-four cat-all"  id="mega-entry-4" data-src="<?php echo base_url(); ?>assets/img/gallery/image4.jpg" data-width="680" data-height="685">
